...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-coffee-dark text-white hover:bg-coffee-dark/90',
        destructive: 'bg-red-500 text-white hover:bg-red-500/90',
        outline: 'border border-coffee-dark bg-white text-coffee-dark hover:bg-coffee-cream',
        secondary: 'bg-coffee-light text-white hover:bg-coffee-light/90',
        ghost: 'hover:bg-coffee-cream hover:text-coffee-dark',
